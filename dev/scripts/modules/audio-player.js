class GreenAudioPlayer {
    ...
    static getTemplate() {
        return `
            ...
            <div class="controls__slider slider" data-direction="horizontal">
                ...
                <span class="controls__current-time eyebrow-2 text-secondary" aria-live="off" role="timer">00:00</span>
                <span class="controls__time-seperator eyebrow-2 text-secondary">/</span>
                <span class="controls__total-time eyebrow-2 text-secondary"> 00:00</span>
            </div>
    ...
    static pausePlayer(player) {
        ...
        const playPauseButtonClass = player.parentElement.querySelector('.play-pause-btn');
        playPauseButtonClass.classList.remove('paused-icon');
    ...
    static playPlayer(player) {
        ...
        const playPauseButtonClass = player.parentElement.querySelector('.play-pause-btn');
        playPauseButton.attributes.d.value = 'M0 0h6v24H0zM12 0h6v24h-6z';
        playPauseButtonClass.classList.add('paused-icon');
        player.play();
    }
